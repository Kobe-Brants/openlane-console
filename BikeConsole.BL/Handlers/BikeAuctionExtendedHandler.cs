...
public class BikeAuctionExtendedHandler : IBikeAuctionMessageHandler
{
    private readonly IGenericRepository<BikeContainer> _bikeContainerRepository;
    private readonly IBikeApiClient _bikeApiClient;

    public BikeAuctionExtendedHandler(IGenericRepository<BikeContainer> bikeContainerRepository, IBikeApiClient bikeApiClient)
    {
        _bikeContainerRepository = bikeContainerRepository;
        _bikeApiClient = bikeApiClient;
    }

    public bool CanHandle(string messageType) => messageType == "BikeAuction.Extended";
